...
//Used to print pulses to Serial
char pulseString[50] = {0};
...
void loop(){
  ...
  //Convert measured pulse count to hex
  sprintf(pulseString,"%02X",pulses);
  //Then print (hex) pulse count to serial
  Serial.println(pulseString);
